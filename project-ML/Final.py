...
class main:
    ...
    def answer(self):
        print("hello world")
        data = pd.read_csv("/home/godsclera/Desktop/project-ML/Manual-Data/Training.csv")
        ...
        test_data = pd.read_csv("/home/godsclera/Desktop/project-ML/Manual-Data/Testing.csv")
